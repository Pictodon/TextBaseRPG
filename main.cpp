...
void main()
{
	...
	enemy[7].health = 2; enemy[7].name = "DAS VAPELORD"; enemy[7].damage = 3; enemy[7].xpGain = 200, enemy[7].maxHealth = 2; enemy[7].drop = 8; enemy[7].hasDrop = true; enemy[7].dropAmount = 1; enemy[7].potentialLoot = 2;
	enemy[8].health = 2; enemy[8].name = "DJ Khaled"; enemy[8].damage = 3; enemy[8].xpGain = 10, enemy[8].maxHealth = 2; enemy[8].drop = 10; enemy[8].hasDrop = true; enemy[8].dropAmount = 1;
